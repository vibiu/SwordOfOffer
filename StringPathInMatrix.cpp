...
void StringPathInMatrixTest(const char *testName, const char *matrix, int rows, int cols, const char *str,
                            bool expected)
{
    if (testName != nullptr)
...
void StringPathInMatrixTest1()
{
    ...
    StringPathInMatrixTest("Test1", (const char *)matrix, 3, 4, str, true);
}
